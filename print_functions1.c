...
/*********************** This will print octal number ***************/
/**
 * print_octal - prints an unsigned octal number
 * @types: List args
 * @buffer: Buffer artray to handle print
 * @flags: Calculates active flags
 * @width: Width
 * @precision: Precision specifier
 * @size: Size specifier
...
/************** This will print unsigned Hexadecimal **************/
/**
...
/************** This will print unsigned number in Hexadecimal **************/
/**
 * print_hexadecimal - Prints an unsigned upper hexadecimal
 * @types: List of args
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width
